export default function Instructors({ className }: { className: string }) {
  return (
    <div className={`${className || ''} container bg-gray-200 text-gray-800 pb-8`}>
      ...
      <div className="flex flex-wrap justify-center">
        <div className="w-full md:w-1/3 p-4">
          ...
          <p className="text-center">John Doe, Chuyên gia về Phát triển Web</p>
        </div>
        <div className="w-full md:w-1/3 p-4">
          <img src="/path/to/instructor2.jpg" alt="Giảng viên 2" className="w-full h-64 object-cover rounded-full mb-4" />
          <p className="text-center">Jane Smith, Chuyên gia về Khoa học Dữ liệu</p>
        </div>
      </div>
    </div>
  );
